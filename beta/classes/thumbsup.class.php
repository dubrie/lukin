...
class thumbsup {
	...
	function draw() {
		...
		$output = '<img src="images/thumbsup.gif" width="18px" height="19px" align="absmiddle"> x <span id="thumbvotes'.$this->thing_id.'" class="thumbsupNumber">'.$votes.'</span>';
		if(!$this->exists($this->thing_id, $this->type, $this->user_id)) {
			$output .= '<br><a href="#" onClick="giveThumbsUp(this, \''.$this->type.'\','.$this->thing_id.','.$votes.');" id="thumbsup_vote">I like this '.$this->type.'</a>';
		}
		return $output;
	}
